...
This will create an executable jar file **parent-thorntail.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/parent-thorntail.jar -Dswarm.port.offset=100
